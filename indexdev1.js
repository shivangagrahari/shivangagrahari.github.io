...
categ.addEventListener('mouseenter',function() {

cat.style.display = 'block';
})
categ.addEventListener('mouseleave', function() {
...
// //
// deve.addEventListener('mouseover', function() {
//
// })
