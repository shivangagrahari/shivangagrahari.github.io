var bd = document.getElementById('db')
var bm = document.getElementById('mb')
var ba = document.getElementById('ab')
var bc = document.getElementById('cb')
...
var redirect = window.confirm('You want to connect on LinkedIn')
  ...
  // prompt('You want to connect to Shivang on LinkedIn')
